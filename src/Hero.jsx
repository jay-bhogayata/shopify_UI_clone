...
const Hero = () => {
  return (
    <div
      id="hero"
      className="bg-myLight py-20 justify-between flex lg:flex-row flex-col items-center lg:px-24 px-5 "
    >
      <div className="w-full lg:w-1/2 lg:pr-10 space-y-10 ">
        ...
        <div className="w-full flex lg:flex-row lg:space-y-0 space-y-4 flex-col justify-between">
          <input
            type="text"
            className="lg:w-2/3 p-3 outline-myGreen placeholder:text-myDark rounded-md "
